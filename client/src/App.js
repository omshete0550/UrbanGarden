  ...
  return (
    <div>
      ...
      <Routes >
        ...
        <Route path="/Products/Products/:productId" element={<SingleProductPage />} />
        <Route path="/category/Products/:productId" element={<SingleProductPage />} />
        <Route path="/category/Products/Products/:productId" element={<SingleProductPage />} />
        <Route path="/nursery/Products/:productId" element={<SingleProductPage />} />
