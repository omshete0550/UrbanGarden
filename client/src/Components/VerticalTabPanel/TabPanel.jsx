...
function TabPanel(props) {
  ...
  return (
    ...
    >
      {value === index && (
        <Box className="profile-tab-panel">
...
export default function VerticalTabs(props) {
  ...
  const fullLocation = [user.city, user.country].filter(Boolean).join(", ");
  const overviewCards = [
    { icon: <FaBoxOpen />, label: "Orders", value: orders.length, text: "Track purchases and delivery status" },
    { icon: <FaShoppingBag />, label: "Wishlist", value: "Saved", text: "Keep favourite plants ready for later" },
    { icon: <FaAddressBook />, label: "Addresses", value: fullLocation || "Add location", text: "Manage preferred delivery details" },
  ];

  if (isNurseryOwner) {
    overviewCards.push({ icon: <FaStore />, label: "Nursery", value: "Owner", text: "Manage nursery and product listings" });
  }

  const profileFields = [
    { icon: <FaUser />, label: "Name", value: user.username || "Not added" },
    {
      icon: <FaPhoneAlt />,
      label: "Mobile No",
  ...
  const ProductOrder = ({ product }) => {
    ...
    useEffect(() => {
      async function fetching(productId) {
        const rest = await axios.get(`${API_BASE_URL}/products/${productId}`);
        setRes(rest.data);
      }
    ...
    if (!res) {
      return (
        <div className="orderproductcard orderproductcard-loading">
    ...
    return (
      <div>
        <div className="orderproductcard" key={res._id}>
          <img src={res.photos?.[0] || "https://images.unsplash.com/photo-1485955900006-10f4d324d411?auto=format&fit=crop&w=300&q=80"} alt={res.name} />
          <div className="orderproductdesc">
            <span>{res.name}</span>
            <p>{((res.description || res.desc) || "No description added.").slice(0, 58).concat("...")}</p>
            <p>
              Price: Rs. {res.price} <br /> Quantity: {product.quantity}{" "}
              <br /> Total: Rs. {calcTotal(res.price, product.quantity)}
            </p>
          </div>
        </div>
      </div>
      ...
      <div>
        {orders.length === 0 ? (
          <div className="empty-profile-state">
            <FaBoxOpen />
            <h3>No orders yet</h3>
            <p>Your plant orders will appear here after checkout.</p>
          </div>
        ) : (
          orders.map((order) => (
            ...
            <div className="orderhistory">
              <div className="orderhistoryheader">
                ...
                <div className="OrderPay">
                  ...
                  <p>{paymentMethods[order.method] || "Payment method"}</p>
                </div>
              </div>
            </div>
  ...
  return (
    ...
    >
      <aside className="profile-tabs">
        ...
        >
          <Tab
            label={tabLabel(<FaLeaf />, "Overview")}
            {...a11yProps(0)}
            sx={{
          ...
          />
          <Tab
            label={tabLabel(<FaBoxOpen />, "Order History")}
            {...a11yProps(1)}
            sx={{
              alignItems: "flex-start",
              minHeight: 54,
          ...
          />
          <Tab
            label={tabLabel(<FaAddressBook />, "Addresses")}
            {...a11yProps(2)}
            sx={{
              alignItems: "flex-start",
              minHeight: 54,
      ...
      <TabPanel value={value} index={0}>
        <div className="UserOverview">
          <div className="UserInfo">
            ...
            <div>
              ...
              <h3>{user.username}</h3>
              <p>
                Keep your plant orders and delivery details growing in one
                place.
              </p>
            </div>
          </div>
        ...
        <div className="UserOverviewGrid">
          {overviewCards.map((card) => (
            <div className="OverviewGirdBox" key={card.label}>
              <i>{card.icon}</i>
      ...
      <TabPanel value={value} index={1}>
        <div>
          <h1 className="profile-section-title">Your Orders</h1>
          {PrevHistCarts()}
        </div>
      </TabPanel>
      ...
      <TabPanel value={value} index={3}>
        <div className="UserProfile">
          <div className="profile-card-header">
            ...
            <button className="profile-edit-link" onClick={handleClickOpen}>
              <FaPen />
          ...
          <div className="ProfileInfo">
            ...
            <div className="profile-info-grid">
              {profileFields.map((field) => (
                <div className="Profile" key={field.label}>
                  <i>{field.icon}</i>
                  <div>
                    <h3>{field.label}</h3>
              ...
              <div className="Profile">
                ...
                <div>
                  <h3>Member Type</h3>
                  <span>Urban Garden Customer</span>
                </div>
              </div>
              <div className="Profile">
                <i>
                ...
                <div>
                  <h3>Payment</h3>
                  <span>Cash on delivery and online payment</span>
                </div>
              </div>
            </div>
                ...
                <div className="addnewaddress-main">
                  <div className="addnewaddress">
                    <div className="addnewaddress-header editheader">
                      <img className="editheadderprofimg" src={avatar} alt="" />
                      <h1>Edit Profile</h1>
                      <X
                        className="closecircleXmarkprof"
                        size={20}
                        strokeWidth={2.5}
                        onClick={closePopup}
                      />
                    ...
                    <button className="EditProfBtn" onClick={addData}>
                      Submit
                    </button>
                  </div>
                </div>
        ...
        <section id="terms-of-service">
          <div className="termCard">
            ...
            <p className="paragraph">
              ...
              represent that you <span className="bold">are</span> of legal age
              to form a binding contract and are{" "}
              <span className="bold">not</span> a person barred from receiving
              ...
              yourself as prompted by beCoditive API's registration form and;{" "}
              <br /> <br />
              ...
              or beCoditive has reasonable grounds to suspect that such
              information is untrue, inaccurate, not current or incomplete,
              beCoditive has the right to suspend or terminate your account and
              refuse any and all current or future use of the beCoditive API (or
              any portion thereof).
              <br />
              <br />
              <br />
              2) Any kind of abusing, harassment using beCoditive API is{" "}
              <span className="bold">strictly prohibited</span>. If anyone is
              found conducting such acts, they will be{" "}
              <span className="bold">banned</span> from the beCoditive API and
              legal action will be taken against them.
              <br />
              <br />
              <br />
              3) beCoditive API provides <span className="bold">ONE</span> API
              key to each person. Trying to generate fakes API keys is strictly{" "}
              <span className="bold">prohibited</span> and this act will result
              in <span className="bold">banning</span> of the person.
              <br />
              <br />
              <br />
              4) beCoditive API is <span className="bold">copyrighted</span> and
              if any acts of <span className="bold">plagiarism</span> are
              discovered, legal action will be taken against the offender.
              <br />
              <br />
              <br />
              5) Flooding beCoditive API with false requests and false complains
              is <span className="bold">strictly prohibited</span>
              <br />
              <br />
              <br />
              ...
              goodwill, use, data or other intangible losses (even if beCoditive
              has been advised of the possibility of such damages), resulting
              from the use or the inability to use beCoditive API.
              <br />
              <br />
              <br />
              8) You <span className="bold">agree</span> that beCoditive may{" "}
              <span className="bold">terminate</span> your access to beCoditive
              API for violations of the TOS and/or requests by authorized law
              ...
              beCoditive API. You further acknowledge that beCoditive reserves
              ...
              beCoditive API (or any part thereof) with or without notice. You
              agree that beCoditive shall not be liable to you or to any third
              party for any modification, suspension or discontinuance of
              beCoditive API.
            </p>
            <p className="footer-heading">
              © Copyright 2023 Urban Garden. All rights reserved.
            </p>
          </div>
        </section>
      </TabPanel>
      <TabPanel value={value} index={5}>
        <div className="privacyPolicy">
          ...
          <p>
            ...
            <br />
            <br />
            Welcome to DeViine.com (the "Site"), provided by DeViine LLC, and
            its affiliates, subsidiaries, parent company and other related
            companies ("Us", "We", or "DeViine"). This DeViine.com Privacy
          ...
          <p>
            The DeViine Services may allow you to connect and share your
            ...
            information from your DeViine account with social networking
            ...
            public, you should not use the DeViine Services in this manner
            ...
            and we do not control these social networking services privacy
          ...
          <p>
            ...
            to the Services and for other marketing purposes of DeViine using
          ...
          <p>
            ...
            fraudulent, abusive, or unlawful uses or to protect DeViine and our
            Services; or any rights, property, or personal safety of DeViine or
            others. 5. In the event that DeViine is or may be acquired by or
          ...
          <p>
            If you believe that DeViine has not adhered to this Statement,
            please contact DeViine by e-mail at support@deviine.com. We will do
          ...
          <p>
            ...
            information with third parties by emailing support@deviine.com.
            ...
            requests by email to support@deviine.com or by one of the other
            means listed below.
          </p>
